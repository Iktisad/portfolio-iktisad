...
const Skills = () => {
  ...
  return (
    <section
      id="skills"
      ref={sectionRef}
      className="relative pt-24 pb-24 overflow-hidden bg-gradient-to-b from-amber-100/25 via-surface to-surface dark:from-transparent dark:via-transparent dark:to-transparent"
    >
      <Momiji />
